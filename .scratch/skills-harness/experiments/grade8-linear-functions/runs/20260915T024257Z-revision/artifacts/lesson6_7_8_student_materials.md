...
1. Compute the rate of change $\frac{\Delta W}{\Delta t}$ between $(4, 156)$ and $(9, 126)$. Include correct units.  
   Rate = ________________________ gallons per minute
...
4. Determine the initial water volume in the tank before the machine started ($t = 0$). Show your method:  
   Initial Volume $b =$ ________________________ gallons
...
A repair technician charges a fixed home-visit diagnostic fee plus a constant hourly labor rate. The table shows the total charge $C$ (in dollars) for jobs taking $h$ hours:
...
1. Calculate the technician's hourly labor rate ($m = \frac{\Delta C}{\Delta h}$). Show your calculation:  
   $m =$ ________________________ dollars per hour
2. Calculate the fixed home-visit fee ($b$). Show how you found it:  
   $b =$ ________________________ dollars
...
4. If a repair job takes 8 hours, what will the total charge be?  
   Total Charge = ________________________ dollars
...
![Figure 7.1: Water Volume in Storage Tanks](lesson7_reservoir_models.svg)
...
2. **Determine the Filling Rate (Slope $m_A$):**
   ...
   - Compute the rate of change:  
     $m_A = \frac{\Delta V}{\Delta t} =$ ________________________ gallons per minute
...
5. **Determine the Draining Rate (Slope $m_B$):**
   ...
   - Compute the rate of change:  
     $m_B = \frac{\Delta V}{\Delta t} =$ ________________________ gallons per minute
...
1. Find the constant draining rate (rate of change) in gallons per minute. Include appropriate sign and units:  
   Rate of change $m =$ ________________________
2. State the initial volume $b$ before draining started:  
   $b =$ ________________________ gallons
...
![Figure 8.0: The Counting Grid Squares Dilemma](task8_1_trap_sketch.svg)
...
![Figure 8.1: Scaled Coordinate Graphs](lesson8_scaled_graphs.svg)
...
3. **Determine Rate of Change using the Slope Triangle:**
   ...
   - Compute the true rate of change (climb speed):  
     $m = \frac{\Delta A}{\Delta t} =$ ________________________ meters per minute
...
4. **Construct the Equation:**
   ...
   - Use your equation to find the altitude of the drone at $t = 11$ minutes:  
     $A(11) =$ ________________________ meters
...
3. **Determine Rate of Change using the Slope Triangle:**
   ...
   - Compute the rate of change:  
     $m = \frac{\Delta F}{\Delta d} =$ ________________________ gallons per mile
...
![Figure 8.2: Mountain Pass Snow Depth](cfu8_snow_graph.svg)
...
4. **Predict Depth:**  
   ...
   Depth after 15 hours = ________________________ inches
...
1. A production cost model for custom school t-shirts records the total cost $C$ (in dollars) based on the number of shirts printed $n$.
   ...
   - What is the total cost to print $80$ shirts? Total Cost = ________________________ dollars
